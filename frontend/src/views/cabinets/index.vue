        ...
        <div v-for="cab in displayItems" :key="cab.id" class="fd-cabinets__card-wrap" @click="goDetail(cab.id)">
          <div class="fd-cabinets__card">
            ...
            <div class="fd-cabinets__thumb">
              <img v-if="cab.photos && cab.photos.length > 0" :src="cab.photos[0]" class="fd-cabinets__thumb-img"
                alt="" />
...
.fd-cabinets {
  ...
  &__card-wrap:nth-child(1) &__card { animation-delay: 0.03s; }
  &__card-wrap:nth-child(2) &__card { animation-delay: 0.06s; }
  &__card-wrap:nth-child(3) &__card { animation-delay: 0.09s; }
  &__card-wrap:nth-child(4) &__card { animation-delay: 0.12s; }
  &__card-wrap:nth-child(5) &__card { animation-delay: 0.15s; }
  &__card-wrap:nth-child(6) &__card { animation-delay: 0.18s; }
  &__card-wrap:nth-child(7) &__card { animation-delay: 0.21s; }
  &__card-wrap:nth-child(8) &__card { animation-delay: 0.24s; }
