  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'items/:id', name: 'ItemDetail', component: () => import('@/views/ItemDetail.vue'), meta: { title: '物品详情', showBack: true } },
        { path: 'items/:id/edit', name: 'ItemEdit', component: () => import('@/views/ItemForm.vue'), meta: { title: '编辑物品', showBack: true } },
        { path: 'cabinets', name: 'Cabinets', component: () => import('@/views/Cabinets.vue'), meta: { title: '储物柜', showTab: true, showAdd: true } },
        { path: 'cabinets/create', name: 'CabinetCreate', component: () => import('@/views/CabinetForm.vue'), meta: { title: '新增储物柜', showBack: true } },
        { path: 'cabinets/:id', name: 'CabinetDetail', component: () => import('@/views/CabinetDetail.vue'), meta: { title: '储物柜详情', showBack: true } },
        { path: 'cabinets/:id/edit', name: 'CabinetEdit', component: () => import('@/views/CabinetForm.vue'), meta: { title: '编辑储物柜', showBack: true } },
